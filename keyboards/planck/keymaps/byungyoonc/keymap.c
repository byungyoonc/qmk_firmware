...
[_QWERTY] = LAYOUT_ortho_4x12(
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    XXXXXXX, KC_UP,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT, KC_RGHT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, KC_DOWN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Del |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  Up  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Menu |  NUM | RAlt |  EXT | Shift| Shift| Space| Space|SYMBOL| Left | Down | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
    KC_DEL,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,
    KC_APP,  NUM,     KC_RALT, EXT,     KC_LSFT, KC_LSFT, KC_SPC,  KC_SPC,  SYM,     KC_LEFT, KC_DOWN, KC_RGHT
),
/* Extend
 * ,-----------------------------------------------------------------------------------.
 * |      |      | Tab  | OSMC |      | Caps |  Del | Home |  Up  | End  | PgUp |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | OGUI | OALT | OCTL | OSFT |      | Bksp | Left | Down | Right| PgDn |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Undo | Cut  | Copy | Paste|      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |   v  |      |      |      |      |      |      |      |
 ...
 */
[_EXTEND] = LAYOUT_ortho_4x12(
    _______, _______, KC_TAB,  KC_OSMC, _______, KC_CAPS, KC_DEL,  KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,
    _______, OLGUI,   OLALT,   OLCTL,   OLSFT,   _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
 ...
 */
[_SYMBOL] = LAYOUT_ortho_4x12(
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_PERC, KC_GRV,  KC_TILD, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  _______,
    _______, OLGUI,   OLALT,   OLCTL,   OLSFT,   XXXXXXX, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, _______,
    _______, KC_AMPR, KC_ASTR, KC_CIRC, KC_DLR,  KC_DLR,  KC_UNDS, KC_LCBR, KC_RCBR, KC_PIPE, _______, KC_DQT,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Number
 * ,-----------------------------------------------------------------------------------.
 ...
 */
[_NUMBER] = LAYOUT_ortho_4x12(
    _______, _______, _______, _______, _______, _______, KC_NUM,  KC_7,    KC_8,    KC_9,    KC_PMNS, _______,
    _______, OLGUI,   OLALT,   OLCTL,   OLSFT,   _______, _______, KC_4,    KC_5,    KC_6,    KC_PPLS, _______,
    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, KC_1,    KC_2,    KC_3,    _______, KC_PDOT,
    _______, _______, _______, _______, _______, _______, KC_0,    KC_0,    _______, _______, _______, _______
),
/* Function
 * ,-----------------------------------------------------------------------------------.
 ...
 */
[_FUNCTION] = LAYOUT_ortho_4x12(
    _______, RGB_TOG, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
    _______, OLGUI,   OLALT,   OLCTL,   OLSFT,   KC_VOLD, XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______,
    _______, KC_SEC1,KC_SEC2,C(S(KC_C)),C(S(KC_V)),KC_MUTE,XXXXXXX,KC_F1,   KC_F2,   KC_F3,   _______, KC_F12,
    _______, _______, _______, _______, NK_TOGG, NK_TOGG, QK_BOOT, QK_BOOT, _______, _______, _______, _______
)
};
#else
