...
[_QWERTY] = LAYOUT_ortho_4x12(
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_TAB,  KC_DEL,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_ESC,  KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LEFT, KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
    XXXXXXX, XXXXXXX, NUM,     EXT,     KC_LSFT, KC_LSFT, KC_SPC,  KC_SPC,  SYM,     KC_RALT, XXXXXXX, XXXXXXX
),
/* Extend
 * ,------------------------------------------------------------------------------------.
...
[_EXTEND] = LAYOUT_ortho_4x12(
    KC_ESC,  KC_TAB,  KC_OSMC, KC_F1,   KC_CAPS, _______, _______, KC_DEL,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   XXXXXXX, _______, _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_LGUI, _______, _______, KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
[_SYMBOL] = LAYOUT_ortho_4x12(
    KC_EXLM, KC_AT,   KC_HASH, KC_PERC, KC_GRV,  _______, _______, KC_TILD, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   XXXXXXX, _______, _______, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT,
    KC_AMPR, KC_ASTR, KC_CIRC, KC_DLR,  KC_DLR,  _______, _______, KC_UNDS, KC_LCBR, KC_RCBR, KC_PIPE, KC_DQT,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Number
 * ,------------------------------------------------------------------------------------.
...
[_NUMBER] = LAYOUT_ortho_4x12(
    KC_ESC,  KC_TAB,  KC_OSMC, KC_F1,   KC_NUM,  _______, _______, KC_DEL,  KC_7,    KC_8,    KC_9,    KC_PMNS,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   XXXXXXX, _______, _______, KC_BSPC, KC_4,    KC_5,    KC_6,    KC_PPLS,
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_LGUI, _______, _______, KC_ENT,  KC_1,    KC_2,    KC_3,    KC_PDOT,
...
[_MKEY] = LAYOUT_ortho_4x12(
    ...
    _______, KC_BTN2, KC_BTN3, KC_BTN1, _______, _______, _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______,
...
[_FUNCTION] = LAYOUT_ortho_4x12(
    RGB_TOG, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, _______, _______, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   KC_VOLD, _______, _______, XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,
    KC_SEC1,KC_SEC2,C(S(KC_C)),C(S(KC_V)),KC_MUTE,_______,_______, XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |Return| Home |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  Up  |  End |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | LNUM | Menu |  NUM |  EXT | Shift| Space|SYMBOL| RAlt | RCtl | Left | Down | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    LNUM,    KC_APP,  NUM,     EXT,     KC_LSFT, KC_SPC,  SYM,     KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
),
/* Extend
 * ,-----------------------------------------------------------------------------------.
 * | Esc  | Tab  | OSMC |  F1  | Caps |      | Home |  Up  | End  | PgUp |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | OGUI | OALT | OCTL | OSFT |      |      | Left | Down | Right| PgDn |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Undo | Cut  | Copy | Paste|      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |   v  |      |      |      |      |      |      |      |      |
 ...
 */
[_EXTEND] = LAYOUT_ortho_4x12(
    KC_ESC,  KC_TAB,  KC_OSMC, _______, KC_CAPS, _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, _______,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, _______,
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Symbol
 * ,-----------------------------------------------------------------------------------.
 ...
 */
[_SYMBOL] = LAYOUT_ortho_4x12(
    KC_EXLM, KC_AT,   KC_HASH, KC_PERC, KC_GRV,  KC_TILD, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  _______, KC_PSCR,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   XXXXXXX, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, _______, _______,
    KC_AMPR, KC_ASTR, KC_CIRC, KC_DLR,  KC_DLR,  KC_UNDS, KC_LCBR, KC_RCBR, KC_PIPE, KC_DQT,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Number
 * ,-----------------------------------------------------------------------------------.
 ...
 */
[_NUMBER] = LAYOUT_ortho_4x12(
    _______, _______, _______, _______, _______, KC_NUM,  KC_7,    KC_8,    KC_9,    KC_PMNS, _______, _______,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   _______, _______, KC_4,    KC_5,    KC_6,    KC_PPLS, _______, _______,
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, KC_1,    KC_2,    KC_3,    KC_PDOT, _______, _______,
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_LNUM] = LAYOUT_ortho_4x12(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_EQL,  _______, _______, _______, _______, _______, _______, _______,
    KC_LCTL, KC_4,    KC_5,    KC_6,    KC_MINS, _______, _______, _______, _______, _______, _______, _______,
    KC_LSFT, KC_7,    KC_8,    KC_9,    KC_0,    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Left Function
 * ,-----------------------------------------------------------------------------------.
...
[_LFN] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______, _______, _______, _______, _______, _______, _______,
    KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* Function
 * ,-----------------------------------------------------------------------------------.
...
#elif defined(SENIPLY_EXT)
    state = update_tri_layer_state(state, _EXTEND, _SYMBOL, _FUNCTION);
    state = update_tri_layer_state(state, _EXTEND, _LNUM, _LFN);
#elif defined(ACAI)
    state = update_tri_layer_state(state, _EXTEND, _SYMBOL, _FUNCTION);
