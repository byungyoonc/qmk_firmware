...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Base Layer
     * .-----------------------------------------------------------------------------------------------------------------------------.
     * | `      | 1      | 2      | 3      | 4      | F5     | F6     | F7     | F8     | F9     | F10    | F11    | F12    | MENU   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
    ...
    [_BASE] = LAYOUT_ortho_5x14(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_APP,
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * | F1     |        | VOL+   |        | RG_ADD | NK_TOG |        | F7     | F8     | F9     | F10    |        |        |        |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
    ...
    [_ADJUST] = LAYOUT_ortho_5x14(
        ...
        KC_F1,   XXXXXXX, KC_VOLU, XXXXXXX, RG_ADD,  NK_TOGG, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, _______,
        _______, KC_MRWD, KC_VOLD, KC_MFFD, XXXXXXX, RGB_TOG, XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______, _______, _______,
