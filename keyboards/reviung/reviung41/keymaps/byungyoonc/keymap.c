...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    KC_F1,   KC_HOME, KC_UP,   KC_END,  KC_WH_U, XXXXXXX,          XXXXXXX, KC_7,    KC_8,    KC_9,    XXXXXXX, KC_DEL,
  ...
  [_ADJUST] = LAYOUT_reviung41(
    ...
    _______, ALTFN,   KC_SEC3, KC_MUTE, KC_VOLD, KC_VOLU,          KC_MRWD, KC_MFFD, KC_MPLY, _______, DEBUG,   _______,
