...
[_MKEY] = LAYOUT(
    ...
    _______, KC_BTN2, KC_BTN3, KC_BTN1, _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______,
    _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______,          _______,          _______, _______, _______
),
/* Space Cadet Symbols
 * ,-----------------------------------------------------------------------.
 ...
 */
[_FUNCTION] = LAYOUT(
    RGB_TOG, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU,  XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,
    OLGUI,   OLALT,   OLCTL,   OLSFT,   KC_VOLD,  XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,
    KC_SEC1,KC_SEC2,C(S(KC_C)),C(S(KC_V)),KC_MUTE,XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12,
